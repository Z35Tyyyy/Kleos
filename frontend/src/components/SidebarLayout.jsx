    ...
    return (
        <div className="flex bg-surface text-on-surface min-h-screen font-['Plus_Jakarta_Sans'] font-medium">
            ...
            <aside className="w-64 fixed left-0 top-0 bg-[#1C1B1B] flex flex-col py-8 px-4 h-full z-50">
                ...
                <Link to="/dashboard" className="bg-gradient-to-br from-[#FFB3B5] to-[#FF5167] text-[#40000C] font-bold py-3 px-6 rounded-xl mb-10 flex items-center justify-center gap-2 hover:scale-[1.02] transition-transform duration-300">
            ...
            <main className="ml-64 flex-1 flex flex-col bg-surface-container-lowest min-h-screen">
                ...
                {/* Global Footer */}
                <footer className="mt-auto py-12 flex justify-center items-center px-12 border-t border-[#5D3F40]/15 bg-[#0E0E0E]">
